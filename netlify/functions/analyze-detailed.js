...
ОТВЕТЬ СТРОГО в JSON формате:
{
  ...
  "morphological_features": "Структурированное описание морфологических характеристик по пунктам в формате: - Сосочки: описание, - Борозды: описание, - Складки: описание, - Текстура: описание, - Налет: описание"
}`;
